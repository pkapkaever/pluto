...
pkgdatadir = $(datadir)/pluto
pkgincludedir = $(includedir)/pluto
pkglibdir = $(libdir)/pluto
pkglibexecdir = $(libexecdir)/pluto
...
am__append_1 = -I$(top_srcdir)/isl/include -I$(top_builddir)/isl/include
am__append_2 = $(top_builddir)/isl/libisl.la
subdir = .
...
CONFIG_CLEAN_FILES = getversion.sh test.sh polycc.sh
...
CTAGS = ctags
CSCOPE = cscope
DIST_SUBDIRS = piplib polylib isl openscop cloog-isl clan candl pet \
	lib tool
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	$(srcdir)/getversion.sh.in $(srcdir)/polycc.sh.in \
	$(srcdir)/test.sh.in AUTHORS ChangeLog INSTALL NEWS compile \
...
ACLOCAL = ${SHELL} /home/huangl/programs/pluto/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/huangl/programs/pluto/missing autoconf
AUTOHEADER = ${SHELL} /home/huangl/programs/pluto/missing autoheader
AUTOMAKE = ${SHELL} /home/huangl/programs/pluto/missing automake-1.16
AWK = gawk
BASH = /bin/bash
BUILD_DIR = /home/huangl/programs/pluto
CC = gcc
...
ISL_INCLUDE =  $(am__append_1)
ISL_LDFLAGS = 
ISL_LIBADD =  $(am__append_2)
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/huangl/programs/pluto/missing makeinfo
MANIFEST_TOOL = :
...
OTOOL64 = 
PACKAGE = pluto
PACKAGE_BUGREPORT = udayb@iisc.ac.in
PACKAGE_NAME = pluto
PACKAGE_STRING = pluto 0.12.0
PACKAGE_TARNAME = pluto
PACKAGE_URL = 
...
STRIP = strip
VERSION = 0.12.0
abs_builddir = /home/huangl/programs/pluto
abs_srcdir = /home/huangl/programs/pluto
abs_top_builddir = /home/huangl/programs/pluto
abs_top_srcdir = /home/huangl/programs/pluto
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/huangl/programs/pluto/install-sh
...
getversion.sh: $(top_builddir)/config.status $(srcdir)/getversion.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
test.sh: $(top_builddir)/config.status $(srcdir)/test.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
polycc.sh: $(top_builddir)/config.status $(srcdir)/polycc.sh.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
